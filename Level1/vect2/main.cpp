...
int main()
{
	...
	v2 += v3; // 2,4
	std::cout << "v2 += v3 (exp:{2,4}): " << v2 << std::endl;
	...
	v2 = 3 * v2; // 9,18
	std::cout << "v2 = 3 * v2 (exp:{9,18}): " << v2 << std::endl;
	
	v2 += v2 += v3; // 20, 40
	std::cout << "v2 += v2 += v3 (exp:{20,40}): " << v2 << std::endl;
	
	v1 *= 42; // -84, -168
	std::cout << "v1 *= 42 (exp:{-84,-168}): " << v1 << std::endl;
	
	v1 = v1 - v1 + v1;
	std::cout << "v1 = v1 - v1 + v1 (exp:{-84,-168}): " << v1 << std::endl;
